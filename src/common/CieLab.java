...
public class CieLab {
	...
	private static double XYZWhiteReference[] = new double[] { 95.047, 100.000, 108.883 };
	private static double XYZEpsilon = 0.008856; // 216/24389
	private static double XYZKappa = 903.3; // 24389/27

//    public Color(double r, double g, double b) {
//        this(new double[]{r, g, b});
//
//    }
	public double[] rgb_to_lab(double RGB[]) {
		return XYZtoLAB(RGBtoXYZ(RGB));
	}

	public static double[] rgb_to_lab(int rgb) {
		double[] RGB = new double[] { Utils.red(rgb), Utils.green(rgb), Utils.blue(rgb) };
		return XYZtoLAB(RGBtoXYZ(RGB));
	}
	...
	public static float lightness(int color) {
		float lightness = (float) rgb_to_lab(color)[0];
		return lightness;
	}
	...
	public static double dist(int col1, int col2) {
		return dist(rgb_to_lab(col1), rgb_to_lab(col2));
	}

	private static double dist(double lab1[], double lab2[]) {
		// Adapted from https://github.com/StanfordHCI/c3
		// https://github.com/gouthamve/ColorSim/blob/master/src/main/java/api/Similarity.java
